      ...
      <nav className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-2 navbar-expand-sm bg-lightBlue-200 mb-3">
        <div className="container px-2 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            <Link href="/Brand/bth_logo.ico">
              <a
                className="text-blueGray-600 text-lg font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap uppercase"
                href="/Brand/bth_logo.ico"
              >
